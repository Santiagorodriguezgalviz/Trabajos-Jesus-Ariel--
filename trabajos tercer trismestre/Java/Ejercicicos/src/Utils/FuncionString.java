...
public class FuncionString {
    ...
    void ShowScanner(String ha_ingresado_un_dato_no_válido_) {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    void ShowJOptionPane(String ha_ingresado_un_dato_no_válido_) {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    String InputJOptionPane(String mensaje) {
        throw new UnsupportedOperationException("Not supported yet."); 
    }

    String InputScanner(String mensaje) {
        throw new UnsupportedOperationException("Not supported yet.");  
    }
