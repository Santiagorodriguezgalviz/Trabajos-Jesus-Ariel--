...
public class FunctionNumeric {
    ...
    public Double InputDoubleNumericRangeScanner(String mensaje, int min, int max) {
        do {            
            InputNumeric(mensaje,1);
    ...
    public Integer InputIntegerNumericRangeScanner(String mensaje, int min, int max) {
