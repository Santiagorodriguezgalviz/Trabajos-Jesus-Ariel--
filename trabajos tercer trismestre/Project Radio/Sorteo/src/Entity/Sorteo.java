...
public class Sorteo {
    ...
    ArrayList<Persona> oyente = new ArrayList<>(50);
    ...
    public ArrayList<Boleto> CrearBoletos() {
        ...
        for (int i = 0; i < 50; i++) {
            ...
            Persona h = new Persona(DocRandom(), NomRandom(b), b, e, NumRandom());
    ...
    public List<Canciones> GenRespuesta() {
        ...
        String[] artista = {"Andy Warhol", "Van Gogh", "Pablo Picasso", "Andy Warhol", "Salvador Dalí", "Frida Kahlo", "Michael Joseph Jackson", "Claude Monet", "Georgia O'Keeffe", "Jackson Pollock"};
